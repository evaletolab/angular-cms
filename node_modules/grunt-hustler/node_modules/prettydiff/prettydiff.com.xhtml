...
<html xml:lang='en' xmlns='http://www.w3.org/1999/xhtml'>
    ...
    <body class="shadow" id="webtool">
        <ul class="default" id="displayOps">
            <li><button id="resetOptions" onclick="pd.reset();return false" title="Clicking this button will clear all stored data and reset all options to the default configuration. I recommend refreshing the page after clicking this button." type="button">Reset
                Options</button></li>
            <li><button id="hideOptions" onclick="pd.hideOptions(this);return false;" title="Clicking this button will visually hide everything except for textarea elements and one 'Execute' button." type="button">Maximize
                Inputs</button></li>
        </ul>
        <div id="top">
            ...
            <div id="introduction"><h2>Introduction</h2>
                ...
                <p id="announcement">If you think this site is ugly then volunteer. Pretty Diff is looking for a visual designer. <a href="mailto:austin.cheney@us.army.mil">Email me</a> to help out.</p>
                <p id="update">Updated:
                </p>
        ...
        <div id="reports"><h2>Reporting data which updates with each use of the
            ...
            <div class="box" id="diffreport">
                <p style="display:none" class="buttons">
                    ...
                    <button class="minimize" onclick="pd.minimize(this);" title="Minimize this dialogue ">&uarr;</button>
                    <button class="maximize" onclick="pd.maximize(this);" title="Maximize this dialogue to the browser window.">&uarr;</button>
                    <button class="resize" onmousedown="pd.resize(event, this);" title="Resize this dialogue.">&harr;</button></p>
                <h3 class="heading" onmousedown="pd.grab(event, this);" title="Grab this title element to open this dialogue or move it around around the screen."><span>Diff
                    Report</span></h3>
            ...
            <div class="box" id="beaureport">
                <p style="display:none" class="buttons">
                    ...
                    <button class="maximize" onclick="pd.maximize(this);" title="Maximize this dialogue to the browser window.">&uarr;</button>
                    <button class="resize" onmousedown="pd.resize(event, this);" title="Resize this dialogue.">&harr;</button></p>
                <h3 class="heading" onmousedown="pd.grab(event, this);" title="Grab this title element to open this dialogue or move it around the screen."><span>Beautify
                    Report</span></h3>
            ...
            <div class="box" id="minreport">
                <p style="display:none" class="buttons">
                    ...
                    <button class="maximize" onclick="pd.maximize(this);" title="Maximize this dialogue to the browser window.">&uarr;</button>
                    <button class="resize" onmousedown="pd.resize(event, this);" title="Resize this dialogue.">&harr;</button></p>
                <h3 class="heading" onmousedown="pd.grab(event, this);" title="Grab this title element to open this dialogue or move it around the screen."><span>Minify
                    Report</span></h3>
            ...
            <div class="box" id="statreport">
                <p style="display:none" class="buttons">
                    ...
                    <button class="maximize" onclick="pd.maximize(this);" title="Maximize this dialogue to the browser window.">&uarr;</button>
                    <button class="resize" onmousedown="pd.resize(event, this);" title="Resize this dialogue.">&harr;</button></p>
                <h3 class="heading" onmousedown="pd.grab(event, this);" title="Grab this title element to open this dialogue or move it around the screen."><span>Usage
                    Statistics</span></h3>
        ...
        <div class="options" id="options"><h2>Main Options</h2>
            <p><strong>Function</strong>
                <span>
                    <input checked="checked" id="modediff" name="mode" onclick="pd.prettyvis(this);" title="This option tells the tool to generate a diff (code comparison) report." type="radio"/>
                    <label for="modediff">Compare Code</label></span>
                <span>
                    <input id="modebeautify" name="mode" onclick="pd.prettyvis(this);" title="This option tells the tool to return well formatted code." type="radio"/>
                    <label for="modebeautify">Beautify Code</label></span>
                <span>
                    <input id="modeminify" name="mode" onclick="pd.prettyvis(this);" title="This option tells thetool to return white space compressed code." type="radio"/>
                    <label for="modeminify">Minify Code</label></span>
            </p>
            <p><label class="label" for="language">Code type</label>
                <select id="language" onchange="pd.codeOps(this)"><option selected="selected" value="auto">Auto
            ...
            <p><strong>Input display</strong>
                <span>
                    <input checked="checked" id="difftall" name="diffdisplay" onclick="pd.prettyvis(this);" title="This option visually orients the base text field to the left of the new text field, or for beautify and minify modes orients the input field to the left of the output field." type="radio"/>
                    <label for="difftall">Orient Vertically</label></span>
                <span>
                    <input id="diffwide" name="diffdisplay" onclick="pd.prettyvis(this);" title="This option visually orients the base text field above the new text field, or for beautify and minify modes orients the input field vertically above the output field." type="radio"/>
                    <label for="diffwide">Orient Horizontally</label></span>
            </p>
            <p><strong>Additional options</strong>
                <span>
                    <input checked="checked" id="additional_no" name="additional" onclick="pd.additional(this);" title="Click me to hide extra options and controls." type="radio"/>
                    <label for="additional_no">Hide additional options</label></span>
                <span>
                    <input id="additional_yes" name="additional" onclick="pd.additional(this);" title="Click me to show extra options and controls." type="radio"/>
                    <label for="additional_yes">Show additional options</label></span>
            </p>
            <p><label class="label" for="colorScheme">Color Scheme</label>
                <select id="colorScheme" onchange="pd.colorScheme(this)"><option>Default</option><option>Coffee</option><option>Dark</option><option>Canvas</option><option selected="selected">Shadow</option><option>White</option></select>
            </p>
            <p><label class="label" for="option_comment">Pretty Diff Comment</label><textarea cols="30" id="option_comment" onmouseout="pd.comment(event, this)" onmouseover="pd.comment(event, this)" readonly="readonly" rows="2" title="This area contains a configuration string as a code comment. This string can be applied to the top of JavaScript and CSS code to supply instructions to the Pretty Diff tool without need to set options in the user interface.">/*prettydiff.com
                */</textarea></p>
        </div>
        <div id="codeInput">
            <div class="difftall" id="diffBase"><h2>Base Text</h2>
                <p class="labeltext"><input id="baselabel" onkeyup="pd.options(this);" type="text" value="base"/>
                    <label for="baselabel">Base label (optional)</label></p>
                <p class="file"><input id="diffbasefile" multiple="multiple" onchange="pd.file(this.files, this)" type="file"/>
            ...
            <div class="difftall" id="diffNew"><h2>New Text</h2>
                <p class="labeltext"><input id="newlabel" onkeyup="pd.options(this);" type="text" value="new"/>
                    <label for="newlabel">New label (optional)</label></p>
                <p class="file"><input id="diffnewfile" multiple="multiple" onchange="pd.file(this.files, this)" type="file"/>
        ...
        <p class="button" onmouseout="pd.comment(event, this)"><button onclick="pd.recycle();" type="button" value="Execute">Execute</button></p>
            ...
            <div class="options" id="beauops" style="display:none;"><h2 title="The term pretty-print is synonymous with code beautification.">Beautify
                ...
                <fieldset><legend>Basic Options</legend>
                    <p><label class="label" for="beau-quan">Indentation Size</label>
                        <span>
                            <input id="beau-quan" onkeyup="pd.options(this);" title="This text field expects a value of 0 or a positive integer. The number provided dictates how many characters constitute a single indentation of formatted code." type="text" value="4"/>
                        </span>
                    </p>
                    <p><label class="label" for="beau-char">Indentation Character</label>
                        <span>
                            <input class="unchecked" id="beau-char" onclick="pd.indentchar(this);" onkeyup="pd.options(this);" title="Accessibility Note:In order for this field to be accepted by the application the radio button labeled 'Indent with Other Characters' must be checked. This text field allows entry of any text characters to constitute indentation." type="text" value="Click me for custom input"/>
                        </span>
                        ...
                        <span>
                            <input checked="checked" id="beau-space" name="beauchar" onclick="pd.indentchar(this);" title="This option indicates a space character will be the character of indentation." type="radio"/>
                            <label for="beau-space">Indent Space</label></span>
                        <span>
                            <input id="beau-tab" name="beauchar" onclick="pd.indentchar(this);" title="This option makes a tab character the character of indentation." type="radio"/>
                            <label for="beau-tab">Indent Tab</label></span>
                        <span>
                            <input id="beau-line" name="beauchar" onclick="pd.indentchar(this);" title="This option makes a new line character the character of indentation." type="radio"/>
                ...
                <fieldset><legend>Advanced Options</legend>
                    ...
                    <p><strong>Indent Comments</strong>
                        ...
                        <span>
                            <input id="incomment-no" name="incomment" onclick="pd.options(this);" title="This option will force comments to the start of the line without the benefit of indentation." type="radio"/>
                    ...
                    <p><strong>Style of Indent (JavaScript Only)</strong>
                        ...
                        <span>
                            <input id="jsindent-all" name="jsindent" onclick="pd.options(this);" title="This JavaScript only option moves opening curly braces onto a new line for visibility of brace contents apart from other code." type="radio"/>
